...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $phones = $em->getRepository('CodersLabBundle:Phone')->findAll();
    ...
    {
        $phone = new Phone();
        $form = $this->createForm('CodersLabBundle\Form\PhoneType', $phone);
    ...
    {
        $deleteForm = $this->createDeleteForm($phone);
        $editForm = $this->createForm('CodersLabBundle\Form\PhoneType', $phone);
