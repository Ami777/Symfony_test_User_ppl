...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $people = $em->getRepository('CodersLabBundle:Person')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CodersLabBundle\Form\PersonType', $person);
    ...
    {
        $deleteForm = $this->createDeleteForm($person);
        $editForm = $this->createForm('CodersLabBundle\Form\PersonType', $person);
